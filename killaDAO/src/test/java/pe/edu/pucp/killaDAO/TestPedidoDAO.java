...
public class TestPedidoDAO {
    ...
    public static void main(String[] args) {
        ...
        try (Connection cn = DBManager.getInstance().getConnection()) {
            ...
            System.out.println("LOAD OK -> " + (cargado != null ? cargado.getEstado() : "null"));

            // 5) UPDATE
            if (cargado != null) {
                cargado.setEstado("CONFIRMADO");
                ...
                System.out.println("UPDATE OK -> " + (actualizado != null ? actualizado.getEstado() : "null"));
            }
